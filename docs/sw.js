/* Painel Comercial — Parque da Saudade + Estrela Urbanidade
   ...
   Antes, 25/09/2026 (tarde) — PONTEAPP: a linha "Falta assinar" do cartão vazava (a classe `.sig` já era a
   ...
   cai sozinha no GET antigo em vez de parar.
   Antes, 24/09/2026 (tarde, 5ª) — PONTEAPP, LEITURA EM PARALELO: a entrega do Google sorteia o
   ...
   Antes, 24/09/2026 (tarde, 2ª) — PONTEAPP: o aviso do lançamento sem venda viva diz o que
   ...
   equipe): uma porta de rede só, espera de até 2 min com contador e nova tentativa sozinha
   quando o Google devolve página de erro; só o token recusado de verdade desloga; cada carga
   numerada; gravação redesenha só a linha dela e avisa quando outra pessoa já tinha mexido
   (conflito, Cofre @99+). Sem bump, a equipe abriria amanhã a tela de 60 s.
   Antes, 21/09/2026 (noite) — PONTEAPP: a tarja diz POR QUE o espelho
   ...
   com "copiar" por campo e a SUGESTÃO de com/sem juros. Rota @76.
   Antes, 19/09/2026 (noite, 2ª) — PONTEAPP: campo "Ref. Ivertex" ao
   ...
   Antes, 19/09/2026 (tarde, 3ª) — PONTEAPP: três correções que faziam
...
const CACHE = 'painel-comercial-260925-5';
